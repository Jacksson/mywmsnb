...
/*                Application ap = fc.getApplication();
    ...
    public void redirect2(String page) {
        FacesContext fc = javax.faces.context.FacesContext.getCurrentInstance();
        try {
...
/*    public void resetBean(String name) {
        Map<String, Object> sessionMap = FacesContext.getCurrentInstance().getExternalContext().getSessionMap();
        Object managedBean = (Object) sessionMap.remove(name);
    }*/
...
/*    public void message(String key, String clientId) {
        FacesContext fc = javax.faces.context.FacesContext.getCurrentInstance();       
        Iterator iter = fc.getMessages();        
        if (iter.hasNext() == false) {
          throw new ValidatorException(new FacesMessage(resolve(key, new Object[]{})));              
        }  
    }*/
