...
public class LOSRack extends BasicClientAssignedEntity{
    ...
    private List<LOSStorageLocation> rackLocations = new ArrayList<LOSStorageLocation>();
	...
	@OrderBy("orderIndex, name")
    public List<LOSStorageLocation> getRackLocations() {
        return rackLocations;
    }

    public void setRackLocations(List<LOSStorageLocation> rackLocations) {
        this.rackLocations = rackLocations;
    }
    
    public void addRackLocation(LOSStorageLocation sl){
        this.rackLocations.add(sl);
    }
    
    public void removeRackLocation(LOSStorageLocation sl){
