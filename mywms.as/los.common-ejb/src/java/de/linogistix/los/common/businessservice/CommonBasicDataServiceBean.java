...
public class CommonBasicDataServiceBean implements CommonBasicDataService {
	...
	public void createBasicData(Locale locale) throws FacadeException {
		...
		propertyService.createSystemProperty(sys, null, LOSCommonPropertyKey.NBCLIENT_RESTORE_TABS, "true", LOSCommonPropertyKey.PROPERTY_GROUP_CLIENT, resolve("PropertyDescNBCLIENT_RESTORE_TABS", locale), false, false);
		propertyService.createSystemProperty(sys, null, LOSCommonPropertyKey.NBCLIENT_SELECTION_UNLIMITED, "true", LOSCommonPropertyKey.PROPERTY_GROUP_CLIENT, resolve("PropertyDescNBCLIENT_SELECTION_UNLIMITED", locale), false, false);
