...
@WebService(name="ManageItemData",
			targetNamespace = "http://itemdata.management.los.linogistix.de", 
			serviceName="ManageItemDataService")
@WebContext(contextRoot = "/webservice", 
		    authMethod = "BASIC", 
