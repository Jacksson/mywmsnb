...
public class LOSGoodsOutRequestQueryBean extends BusinessObjectQueryBean<LOSGoodsOutRequest> implements
	...
	protected List<BODTOConstructorProperty> getBODTOConstructorProperties() {
		...
		propList.add(new BODTOConstructorProperty("customerOrder.number", null, BODTOConstructorProperty.JoinType.LEFT, "customerOrder"));
		propList.add(new BODTOConstructorProperty("customerOrder.externalNumber", null, BODTOConstructorProperty.JoinType.LEFT, "customerOrder"));
		propList.add(new BODTOConstructorProperty("customerOrder.externalId", null, BODTOConstructorProperty.JoinType.LEFT, "customerOrder"));
		propList.add(new BODTOConstructorProperty("customerOrder.customerNumber", null, BODTOConstructorProperty.JoinType.LEFT, "customerOrder"));
		propList.add(new BODTOConstructorProperty("customerOrder.customerName", null, BODTOConstructorProperty.JoinType.LEFT, "customerOrder"));
