...
//		String logStr = "getAdvicedAmount ";
	...
	private List<AdviseLotResult> getAdviseLotInv(Client c, Lot lot, ItemData idat) {
		...
		b.append("(");
		b.append("client.number, item.number, item.scale, ad.notifiedAmount, ad.receiptAmount, lot.name");
		b.append(")");
		b.append(" FROM ");
	...
	final static class AdviseLotResult implements Serializable {
		...
		public AdviseLotResult(String clientNumber, String itemNumber, int itemScale, BigDecimal notifiedAmount, BigDecimal receiptAmount, String lotName) {
