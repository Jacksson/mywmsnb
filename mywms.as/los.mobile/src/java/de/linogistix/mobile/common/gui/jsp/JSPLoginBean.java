    ...
    public String getMessage() {
        ...
        if (helper.getRequestQueryString() != null) {
            if (helper.getRequestQueryString().equals("errors=true")) {
                if (helper.getRequestParameter("j_username").equals("")) {
                    return getHTMLMessage(resolve("UserEntryEmpty"));
                }
                if (helper.getRequestParameter("j_password").equals("")) {
                    return getHTMLMessage(resolve("PasswordEntryEmpty"));
                }
